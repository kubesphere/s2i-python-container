    ...
    stage('push to dockerhub'){
      ...
      steps{
        container('go'){
          ...
          sh '''docker tag kubespheredev/python-27-centos7 kubespheredev/python-27-centos7:2.1.0
docker tag kubespheredev/python-34-centos7 kubespheredev/python-34-centos7:2.1.0
docker tag kubespheredev/python-35-centos7 kubespheredev/python-35-centos7:2.1.0
docker tag kubespheredev/python-36-centos7 kubespheredev/python-36-centos7:2.1.0 
'''
