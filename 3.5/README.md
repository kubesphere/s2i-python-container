...
This container image includes Python 3.5 as a [S2I](https://github.com/kubesphere/s2ioperator) base image for your Python 3.5 applications.
Users can choose between RHEL and CentOS based builder images.
The CentOS7 image is then available on [Docker Hub](https://hub.docker.com/r/kubespheredev/python-35-centos7/)
as kubespheredev/python-35-centos7.
...
Usage
---------------------
To build a simple [python-sample-app](https://github.com/kubesphere/s2i-python-container/tree/master/3.5/test/setup-test-app) application
...
* **APP_MODULE**
    ...
    [setup-test-app](https://github.com/kubesphere/s2i-python-container/tree/master/3.5/test/setup-test-app).
