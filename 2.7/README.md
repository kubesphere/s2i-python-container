...
This container image includes Python 2.7 as a [S2I](https://github.com/kubesphere/source-to-image) base image for your Python 2.7 applications.
...
For this, we will assume that you are using the supported image, available via `python:2.7` imagestream tag in kubesphere.
